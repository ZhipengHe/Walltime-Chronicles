...
!!! info "The emails"
    ...
    `Exit_status=0` means the script's last command finished without an error. Anything else, and the times `0` is not the whole story, is [Lesson 5](lesson-5.md)'s business.
