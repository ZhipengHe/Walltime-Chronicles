...
#### GPU A100 Batch — the legacy classic (5 nodes) { #a100-batch }
...
For the higher-level filesystem orientation, see Lesson 1's [Where your files live](../tutorials/lesson-1.md#where-your-files-live) section. This page focuses on the *node-level* picture.
...
- :material-book-open-page-variant: [Lesson 1: Welcome to Aqua](../tutorials/lesson-1.md) — the cluster mental model, where files live, login vs compute nodes, and your first interactive job.
