...
!!! info "See full recipe of `pbs_brew_inspector.sh` at the end of this page."
...
Copy the below script and save it as `pbs_brew_inspector.sh` to your server to use it. Or you can download it from [here]().
